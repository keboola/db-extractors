...
trait SalesTableTrait
{
    ...
    {
        return [
            'usergender' => 'NVARCHAR2 (400)',
            'usercity' => 'NVARCHAR2 (400)',
            'usersentiment' => 'NVARCHAR2 (400)',
            'zipcode' => 'NVARCHAR2 (400)',
            'sku' => 'NVARCHAR2 (400)',
            'createdat' => 'NVARCHAR2(64) NOT NULL',
            'category' => 'NVARCHAR2 (400)',
            'price' => 'NVARCHAR2 (400)',
            'county' => 'NVARCHAR2 (400)',
            'countycode' => 'NVARCHAR2 (400)',
            'userstate' => 'NVARCHAR2 (400)',
            'categorygroup' => 'NVARCHAR2 (400)',
        ];
    }
}
