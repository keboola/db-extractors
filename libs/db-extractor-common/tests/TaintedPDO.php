...
class TaintedPDO extends \PDO
{
    ...
    {
        fwrite(STDERR, sprintf('[%s] Preparing ' . $statement, date('Y-m-d H:i:s')) . PHP_EOL);
        call_user_func($this->callback, 'prepare', null, $this);
        return parent::prepare($statement, $options); // TODO: Change the autogenerated stub
    }
